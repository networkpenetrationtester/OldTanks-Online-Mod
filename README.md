...
2.	Download my NNBounce-node Resource Proxy repo. https://github.com/networkpenetrationtester/NNBounce-node
	It's a TypeScript HTTP proxy, which can either load resources from your disk, from a URL you specify in config.json.
...
4.	Download & Extract otgithub LATEST TAG RELEASE titled "Important". (https://github.com/bjuonday/otgithub/archive/refs/tags/app.zip)
